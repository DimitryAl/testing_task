...
int main()
{
    ...
    int maxWidth = 10;    // максимальны€ ширина треугольника
    int maxHeight = 10;   // максимальна€ высота треуголтника
    int maxDstSize = 20;  // макс кол-во треуголтников в выходном массиве
    int* scrTreatedCount = 0;   //„исло подлностью обработанных входных треугольников
